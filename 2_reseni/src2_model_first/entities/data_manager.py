...
class DataManager():
    ...
    def clean_data(self):
        ...
        books = pd.read_csv(books_path,
                            ...
                            sep=';',
                            on_bad_lines='skip', 
                            # parse columns as int if possible, otherwise NaN
        ...
        # TBD check result counts...
        # TBD it is possible to merge on book-title (and author) as well. Allowing for fuzzy matching could be useful, but not 100% safe.
        # Fuzzy matchin could result in better results, however, recommendations would need to include all ISBN for one book.
